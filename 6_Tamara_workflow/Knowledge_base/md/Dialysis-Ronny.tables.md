...
The peer reviewed article 'Dialysis is a key factor modulating interactions between critical process parameters during the microfluidic preparation of lipid nanoparticles' was originally published in Colloid and Interface Science Communications in April 2023 by Ronny Vargas and al.
...
In the case of PDI, the traditional approach only considering TFR and FRR might provide the best fit
...
|                     | Nanoparticle characteristics   | Nanoparticle characteristics   | Nanoparticle characteristics   | Nanoparticle characteristics   | Nanoparticle characteristics   | Nanoparticle characteristics   |
|---------------------|--------------------------------|--------------------------------|--------------------------------|--------------------------------|--------------------------------|--------------------------------|
| Synthesis parameter | Average Size                   | Average Size                   | Zeta potential                 | Zeta potential                 | PDI                            | PDI                            |
|                     |                                | After dialysis                 | Before dialysis                | After dialysis                 | Before dialysis                | After dialysis                 |
| TFR Increase        |                                |                                |                                |                                |                                |                                |
| FRR Increase        |                                |                                |                                |                                |                                |                                |
